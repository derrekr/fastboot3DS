...
typedef enum
{
	...
	IPC_CMD9_TOGGLE_SUPERHAX     = CMD_ID(35) | CMD_IN_BUFS(0)  | CMD_OUT_BUFS(0)  | CMD_PARAMS(1),
	IPC_CMD9_PREPARE_POWER       = CMD_ID(36) | CMD_IN_BUFS(0)  | CMD_OUT_BUFS(0)  | CMD_PARAMS(0),
	IPC_CMD9_PANIC               = CMD_ID(37) | CMD_IN_BUFS(0)  | CMD_OUT_BUFS(0)  | CMD_PARAMS(0),
	IPC_CMD9_EXCEPTION           = CMD_ID(38) | CMD_IN_BUFS(0)  | CMD_OUT_BUFS(0)  | CMD_PARAMS(0)
} IpcCmd9;
