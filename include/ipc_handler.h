...
#define IPC_CMD_OUT_BUFS_MASK(cmd)  ((cmd)>>26 & 0xFu)
...
typedef enum
{
	...
	IPC_CMD9_FREAD             = CMD_ID(4)  | CMD_IN_BUFS(0)  | CMD_OUT_BUFS(1)  | CMD_PARAMS(4),
	IPC_CMD9_FWRITE            = CMD_ID(5)  | CMD_IN_BUFS(1)  | CMD_OUT_BUFS(0)  | CMD_PARAMS(4),
